 ...
 * |-----------------------------------------------------------|
 * |Ctl|| Fn|Win|Alt|MHN|   Spc   |HEN|KNA|Alt| Fn||Lft|Dwn|Rgh|
 * `-----------------------------------------------------------'
 */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_JP(
        ...
        KC_LCTL, MO(1), KC_LGUI, KC_LALT, KC_MHEN, KC_SPC, KC_HENK, KC_KANA, KC_RALT, MO(1), KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [1] = LAYOUT_JP(
        ...
        _______, _______, _______, _______, _______, _______, KC_PPLS, KC_PMNS, KC_END, KC_PGDN, KC_DOWN, KC_PGUP, _______, _______,
